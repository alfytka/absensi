  ...
  <div class="row">
    <div class="col-lg-4 mb-5">
      <div class="card shadow-sm">
        <div class="card-body">
          <h5 class="card-title"><i class="bi bi-plus-lg"></i> Tambah Mapel</h5>
          <form class="row g-3" action="/mata-pelajaran" method="POST">
            @csrf
            ...
            <div class="col-12 px-3 px-md-2">
              ...
              <input type="text" name="nama_mapel" class="form-control @error('nama_mapel') is-invalid @enderror" value="{{ old('nama_mapel') }}" placeholder="con: Sejarah Indonesia - XI" id="nama_mapel" autocomplete="off">
              @error('nama_mapel')
                <span class="invalid-feedback">{{ $message }}</span>
              @enderror
            </div>
              ...
              <tbody class="align-middle">
                ...
                <tr>
                  ...
                  <td class="align-middle">
                    <a href="/mata-pelajaran/{{ $mapel->id }}" class="text-secondary pe-2">
                    ...
                    <a href="#" data-bs-toggle="modal" data-bs-target="#datamapel{{ $mapel->id }}" class="text-secondary">
                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" style="width:18px;">
