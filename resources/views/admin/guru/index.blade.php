        ...
        <div class="card-body">
          <div class="row px-1 my-2 bg-light rounded">
            <div class="col-6 my-auto py-2 py-md-3">
              <a href="{{ route('guru.create') }}" class="btn btn-sm btn-outline-primary rounded-2"><span class="bi bi-plus-lg"></span> <span class="d-none d-md-inline d-lg-inline">Tambah</span> Guru</a>
            </div>
          </div>
            ...
            <table class="table table-sm table-striped table-hover" id="table1">
              ...
              <tbody class="align-middle">
                ...
                <tr>
                  ...
                  <td>{{ $guru->nip }}</td>
                  <td>{{ $guru->jenis_kelamin == 'laki-laki' ? 'L' : 'P' }}</td>
                  <td style="min-width: 200px;">{{ $guru->nama }}</td>
                  <td>{{ $guru->email }}</td>
                  <td class="align-middle">
                    <a href="/guru/{{ $guru->id }}" class="text-secondary pe-2">
                    ...
                    <a href="#" data-bs-toggle="modal" data-bs-target="#dataguru{{ $guru->id }}" class="text-secondary">
                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" style="width:18px;">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M14.74 9l-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 01-2.244 2.077H8.084a2.25 2.25 0 01-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 00-3.478-.397m-12 .562c.34-.059.68-.114 1.022-.165m0 0a48.11 48.11 0 013.478-.397m7.5 0v-.916c0-1.18-.91-2.164-2.09-2.201a51.964 51.964 0 00-3.32 0c-1.18.037-2.09 1.022-2.09 2.201v.916m7.5 0a48.667 48.667 0 00-7.5 0" />
                      </svg>
                    </a>
                  </td>
                  <div class="modal fade" id="dataguru{{ $guru->id }}" tabindex="-1">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          ...
                          <span class="text-violet fw-semibold fst-italic">{{ $guru->nama }} ?</span>
                        </div>
                        <div class="modal-footer">
                          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
                          <form action="/guru/{{ $guru->id }}" method="POST" class="m-0">
                            @csrf
                            @method('DELETE')
