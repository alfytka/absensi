        ...
        <div class="card-body">
          <div class="row px-1 my-2 bg-light rounded">
            <div class="col-6 my-auto py-2 py-md-3">
              <a href="{{ route('siswa.create') }}" class="btn btn-sm btn-outline-primary rounded-2"><span class="bi bi-plus-lg"></span> <span class="d-none d-md-inline d-lg-inline">Tambah</span> Siswa</a>
            </div>
          </div>
            ...
            <table class="table table-sm table-striped table-hover" id="table1">
              ...
              <tbody class="align-middle">
                ...
                <tr>
                  ...
                  <td>{{ $siswa->nis }}</td>
                  <td style="min-width: 200px;">{{ $siswa->nama }}</td>
                  <td style="min-width: 100px;">{{ $siswa->kelas->nama_kelas }}</td>
                  <td>{{ $siswa->email }}</td>
                  <td class="align-middle">
                    <a href="/siswa/{{ $siswa->id }}" class="text-secondary pe-2">
                    ...
                    <a href="#" data-bs-toggle="modal" data-bs-target="#datasiswa{{ $siswa->id }}" class="text-secondary">
                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" style="width:18px;">
                  ...
                  <div class="modal fade" id="datasiswa{{ $siswa->id }}" tabindex="-1">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          Hapus data siswa dengan nama:<br>
                          <span class="text-violet fw-semibold fst-italic">{{ $siswa->nama }} ?</span>
                        </div>
                        <div class="modal-footer">
                          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
                          <form action="/siswa/{{ $siswa->id }}" method="POST" class="m-0">
                            @csrf
                            @method('DELETE')
